...
photuc = ee.FeatureCollection("projects/ryer7052-ee/assets/photuc_area")  # type: ignore

# Export paths for final prediction grid
tif_path = os.path.join(os.path.expanduser('~'),'Documents','Github','UCBMasters','data','tifs')
